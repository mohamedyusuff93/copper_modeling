...
class prediction:
    ...
    def regression():
        ...
        if button:
            ...
            with open(r"C:/Users/srira.SRIRAM-SD/OneDrive/Desktop/Data science/Copper modeling/regression_model.pkl", 'rb') as f:
                model = pickle.load(f)
    ...
    def classification():
        ...
        if button:
            ...
            with open(r"C:/Users/srira.SRIRAM-SD/OneDrive/Desktop/Data science/Copper modeling/classification_model.pkl", 'rb') as f:
                model = pickle.load(f)
